# Приложение «Мобильный хоспис» (FMHAndroid)

# Автоматизированное тестирование FMHAndroid

## 1. Описание проекта
Данный репозиторий содержит автотесты для Android-приложения **FMHAndroid**, реализованные с использованием фреймворка **Espresso** и архитектуры **Page Object Model**.

Для формирования отчетов о результатах тестирования используется **Allure Framework**.
...
- JDK 8 или JDK 11;
- Android SDK;
- Подключенное физическое устройство или Android-эмулятор;
- Установленный Allure.

---

## 3. Структура проекта
src/androidTest/java/ru/iteco/fmhandroid/
...
## 4. Запуск автотестов через Android Studio
1. Открыть проект в Android Studio;
2. Подключить устройство или запустить эмулятор;
3. Перейти в пакет `androidTest`;
4. Запустить тесты через `Run`.
